...
KEDA добавляет в кластер горизонтальный автоскейлинг приложений по внешним метрикам. Почему выбран именно KEDA, а не нативный HPA — наглядно видно из сравнения с обычным HPA и связкой HPA + prometheus-adapter:
