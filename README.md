...
│ свободные ресурсы: │   │ HPA создаёт        │   │ pause-поды         │   │ CA создаёт ноду    │   │ pause-под Running  │
│ pause-под держит   │   │ новые реплики      │   │ переходят в        │   │                    │   │ буфер готов        │
│ буфер на ноде      │   └────────────────────┘   │ Pending (секунды)  │   └────────────────────┘   └────────────────────┘
└────────────────────┘                            └────────────────────┘
```
